...
public interface Node extends MeshCoreVertex<NodeResponse, Node>, CreatorTrackingVertex, IndexableElement {
	 ...
	 * @param ignoreChecks
	 */
	void deleteFromRelease(InternalActionContext ac, Release release, BulkActionContext context, boolean ignoreChecks);
	 ...
	 * @param ignoreChecks
	 */
	void delete(BulkActionContext context, boolean ignoreChecks);
