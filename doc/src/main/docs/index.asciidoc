...
Try our link:/api/v1/demo/graphql/browser/[Demo].
...
Gentics Mesh currently supports multiple ways of authentication.
You can login via:
...
The token only lasts a certain amount of time (which can be configured in the `mesh.yml` file), so it might be necessary to refresh the token. 
The JWT will be automatically renewed by every request on the Gentics Mesh API. Additionally it is also possible to manually refresh the token using a GET request on the `/api/v1/auth/refresh` endpoint.
This will set create new token which has a refreshed expire time.

===== JWT Configuration

The _Json Web Token_ store can be configured within the main `mesh.yml` config file.
...
A user can be authenticated by invoking a regular GET request to `/api/v1/auth/login` which includes a http://tools.ietf.org/html/rfc1945#section-11.1[[Basic Authentication HTTP header].
...
include::examples/request/api/v1/\{project\}/nodes/request-body.json[]
----
...
include::examples/request/api/v1/\{project\}/nodes/\{nodeUuid\}/request-body.json[]
----
...
| nodeReference | Node reference which can be used to store additional user data.
| enabled       | Enabled flag. Disabled users can no longer log into Gentics Mesh. A deleted user will not be completely removed. Instead the user will just be disabled.
...
[source,json]
----
include::examples/response/api/v1/users/\{userUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/groups/\{groupUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/roles/\{roleUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/projects/\{projectUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/tags/\{tagUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/\{project\}/nodes/\{nodeUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/response/api/v1/schemas/\{schemaUuid\}/200/example.json[]
----
...
[source,json]
----
include::examples/mesh-config.yml[]
----
...
[source,json]
----
include::examples/addfield.json[]
----
...
[source,json]
----
include::examples/removefield.json[]
----
...
[source,json]
----
include::examples/changefieldtype.json[]
----
...
[source,json]
----
include::examples/updatefield.json[]
----
...
[source,json]
----
include::examples/updateschema.json[]
----
...
[source,json]
----
include::examples/updatemicroschema.json[]
----
...
[source,json]
----
include::examples/request/api/v1/schemas/\{schemaUuid\}/changes/request-body.json[]
----
...
[source,json]
----
include::examples/response/api/v1/\{project\}/nodes/\{nodeUuid\}/published/200/example.json[]
----
...
[source,json]
----
include::examples/request/api/v1/\{project\}/releases/\{releaseUuid\}/schemas/request-body.json[]
----
...
[source,json]
----
include::examples/request/api/v1/\{project\}/releases/\{releaseUuid\}/microschemas/request-body.json[]
----
...
[source,json]
----
include::examples/user.search.json[]
----
...
[source,json]
----
include::examples/group.search.json[]
----
...
[source,json]
----
include::examples/role.search.json[]
----
...
[source,json]
----
include::examples/node.search.json[]
----
...
[source,json]
----
include::examples/project.search.json[]
----
...
[source,json]
----
include::examples/tag.search.json[]
----
...
[source,json]
----
include::examples/tagFamily.search.json[]
----
...
[source,json]
----
include::examples/schema.search.json[]
----
...
[source,json]
----
include::examples/microschema.search.json[]
----
