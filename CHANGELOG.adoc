...
icon:bullhorn[] The `expand` and `expandAll` parameters have been removed. It is no longer possible to expand nodes. Use GraphQL if you want to retrieve deeply nested data.
